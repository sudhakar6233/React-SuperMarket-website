        ...
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div className="col-lg-6">
            ...
            <div className="d-grid gap-2 d-md-flex justify-content-md-start">
              <Link to="/shop" className="btn btn-success btn-lg px-4 me-md-2">Shop Now</Link>
          ...
          <div className="row text-center text-md-center d-flex justify-content-between">
            ...
            <div className="col-md-3 mb-4">
              ...
              <ul className="list-unstyled">
                ...
                <li><Link to="/about" className="text-white text-decoration-none d-block py-1">About Us</Link></li>
                ...
                <li><Link to="/faq" className="text-white text-decoration-none d-block py-1">FAQ</Link></li>
              </ul>
            </div>
            ...
            <div className="col-md-3 mb-4">
              ...
              <ul className="list-unstyled">
                <li><Link to="/support" className="text-white text-decoration-none d-block py-1">Customer Support</Link></li>
                <li><Link to="/shipping" className="text-white text-decoration-none d-block py-1">Shipping & Delivery</Link></li>
                <li><Link to="/returns" className="text-white text-decoration-none d-block py-1">Returns & Refunds</Link></li>
            ...
            <div className="col-md-3 mb-4 text-center text-md-start">
              ...
              <div className="d-flex justify-content-center justify-content-md-start gap-3">
                <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-white social-icon"><FaFacebook size={28} /></a>
                <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-white social-icon"><FaInstagram size={28} /></a>
                <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-white social-icon"><FaTwitter size={28} /></a>
              </div>
